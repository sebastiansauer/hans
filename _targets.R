...
list(
  ...
  tar_target(n_action_fingerprint,
   data_separated_filtered|> 
  ...
  tar_target(n_action_w_date,
             data_separated_filtered |> 
               count_action_w_date()),
  tar_target(n_action_w_date_fingerprint,
             data_separated_filtered |> 
  ...
  tar_target(time_spent_fingerprint,
  ...
  tar_target(time_spent_w_course_university_fingerprint,
    compute_time_per_course_uni(
  ...
  tar_target(time_visit_wday_fingerprint,
  ...
  tar_target(timestamps_added_to_fingerprints,
  ...
  tar_target(n_mc_answers_selected,
  data_separated_filtered |> 
    count_mc_answers() |> 
    group_by(idvisit) |> 
    count()),
  ...
  tar_target(mc_answers_with_timestamps,
  ...
  tar_target(idvisit_has_llm_fingerprint, 
             data_separated_filtered |> 
