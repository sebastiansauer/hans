...
```{r plot-count-action}
count_action_avg = mean(count_action$nr_max) |> round(0)
count_action_sd = sd(count_action$nr_max) |> round(0)
...
count_action |> 
  ...
  geom_segment(x = count_action_avg-count_action_sd,
               ...
               size = 2) +
  annotate("label", x = count_action_avg, y = 1500, 
           label = paste0("MW = ", count_action_avg)) +
  annotate("label", 
           x = count_action_avg + count_action_sd, 
           y = 0, 
           label = paste0("SD = ", count_action_sd))
...
count_action_avg2 = mean(count_action2$nr_max) |> round(0)
count_action_sd2 = sd(count_action2$nr_max) |> round(2)
...
count_action2 |> 
  ...
  geom_segment(x = count_action_avg-count_action_sd2,
               ...
               color = palette_okabe_ito()[2],
               size = 2) +
  annotate("label", x = count_action_avg2, y = 1500, 
           label = paste0("MW = ", count_action_avg2)) +
  annotate("label", 
           x = count_action_avg2 + count_action_sd2, 
           y = 0, 
           label = paste0("SD = ", count_action_sd2))
  #geom_label(aes(x = count_action_avg), y = 1, label = "Mean")
```
...
time_spent |> 
  ...
  theme_minimal() +
  labs(y = "n",
       x = "Verweildauer in HaNS pro Visit in h:m:s") +
...
time_spent |> 
  ...
  labs(y = "n",
       ...
       title = "Verweildauer in HaNS pro Visit in h:m:s",
